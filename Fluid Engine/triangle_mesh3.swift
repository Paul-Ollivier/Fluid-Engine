...
extension MDLVertexDescriptor {
    static var defaultVertexDescriptor: MDLVertexDescriptor = {
        ...
        var offset = 0
        //MARK:- position attribute
        // vertexDescriptor.attributes[Int(MDLVertexAttributePosition.rawValue)] =
        vertexDescriptor.attributes[0] =
            MDLVertexAttribute(name: MDLVertexAttributePosition,
                                 format: .float3,
                                 offset: 0,
                                 bufferIndex: 0) // Int(MDLBufferIndexVertices.rawValue)
        offset += MemoryLayout<SIMD3<Float>>.stride
        
        //MARK:- normal attribute
        //vertexDescriptor.attributes[Int(MDLVertexAttributeNormal.rawValue)] =
        vertexDescriptor.attributes[1] =
            MDLVertexAttribute(name: MDLVertexAttributeNormal,
                               format: .float3,
                               offset: offset,
                               bufferIndex: 0) // Int(BufferIndexVertices.rawValue)
        offset += MemoryLayout<SIMD3<Float>>.stride
        
        //MARK:- add the uv attribute here
        // vertexDescriptor.attributes[Int(MDLVertexAttributeTextureCoordinate.rawValue)] = // UV
        ...
        // vertexDescriptor.attributes[Int(MDLVertexAttributeTangent.rawValue)] =
        ...
        // vertexDescriptor.attributes[Int(MDLVertexAttributeBitangent.rawValue)] =
        ...
        //MARK:- color attribute
        // vertexDescriptor.attributes[Int(MDLVertexAttributeColor.rawValue)] =
        ...
        //MARK:- joints attribute
        // vertexDescriptor.attributes[Int(MDLVertexAttributeJointIndices.rawValue)] =
        vertexDescriptor.attributes[6] =
            MDLVertexAttribute(name: MDLVertexAttributeJointIndices,
                               format: .uShort4,
                               offset: offset,
                               bufferIndex: 0) // Int(BufferIndexVertices.rawValue)
        ...
        // vertexDescriptor.attributes[Int(MDLVertexAttributeJointWeights.rawValue)] =
        vertexDescriptor.attributes[7] = 
            MDLVertexAttribute(name: MDLVertexAttributeJointWeights,
                               format: .float4,
                               offset: offset,
                               bufferIndex: 0) // Int(BufferIndexVertices.rawValue)
